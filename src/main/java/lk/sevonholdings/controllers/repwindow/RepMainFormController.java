package lk.sevonholdings.controllers.repwindow;

import javafx.event.ActionEvent;
import javafx.scene.input.MouseEvent;

public class RepMainFormController {
    ...
    public void setOnMouseDraggedtitlebar(MouseEvent mouseEvent) {
    }

    public void setOnMousePressedtitlebar(MouseEvent mouseEvent) {
    }
    ...
    public void showStocksOnAction(ActionEvent actionEvent) {
    }

    public void setOnLiveBiscuits(ActionEvent actionEvent) {
    }

    public void setOnMyTarget(ActionEvent actionEvent) {
    }

    public void setOnWarehouseScene(ActionEvent actionEvent) {
    }

    public void setShopScene(ActionEvent actionEvent) {
    }

    public void setShopOrderScene(ActionEvent actionEvent) {
    }

    public void setOnProductsScene(ActionEvent actionEvent) {
    }
