...
public class Product implements SuperEntity{
    ...
    public Product(String biscuitsNo, String imagePath, String biscuitRange, String biscuitBrand, String size, double CBFVolume, double supplierPrice, double distributorPrice, double MRPrice) {
