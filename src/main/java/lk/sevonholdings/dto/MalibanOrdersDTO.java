...
public class MalibanOrdersDTO {
    ...
    public MalibanOrdersDTO(String orderId, String biscuitNo, String range, String brand, String size, int QTY, double supplierCost, double distributorCost, double MRP) {
        OrderId = orderId;
        BiscuitNo = biscuitNo;
        Range = range;
        Brand = brand;
