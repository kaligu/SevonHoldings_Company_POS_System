...
public class SupplierOrderDTO {
    ...
    public SupplierOrderDTO(String order_Id, java.sql.Date date, java.sql.Time time, double totalSupplierCost, double totalDistributorCost, double totalMRPrice, String avalability) {
        Order_Id = order_Id;
        Date = date;
        Time = time;
