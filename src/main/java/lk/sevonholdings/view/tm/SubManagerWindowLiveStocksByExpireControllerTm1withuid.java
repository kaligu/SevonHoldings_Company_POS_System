...
public class SubManagerWindowLiveStocksByExpireControllerTm1withuid {
    ...
    public SubManagerWindowLiveStocksByExpireControllerTm1withuid(String warehouse_Use_Id, String malibanOrder_id, String other, String biscuit_No, String imagePath, String biscuit_Brand, String size, int availableQty, Date MFD, Date EXD, String room_Id, String remaining_days_expired, double remaining_Value_Pbar) {
