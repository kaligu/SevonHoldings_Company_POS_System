...
public class ProductsTm {
    ...
    public ProductsTm(String biscuitsNo, ImageView imagePath, String biscuitRange, String biscuitBrand, String size, double CBFVolume, double supplierPrice, double distributorPrice, double MRPrice) {
