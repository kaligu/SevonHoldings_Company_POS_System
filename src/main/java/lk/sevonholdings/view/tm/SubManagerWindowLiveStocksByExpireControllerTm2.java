...
public class SubManagerWindowLiveStocksByExpireControllerTm2 {
    ...
    public SubManagerWindowLiveStocksByExpireControllerTm2(String biscuit_No, ImageView imagePath, String biscuit_Brand, String size, int availableQty, Date MFD, Date EXD, String room_Id, String remaining_days_expired, ProgressBar remaining_Value_Pbar) {
